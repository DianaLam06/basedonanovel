...
# also will want to merge in the number of copies of the book
...
names(imdb_movies)
movies <- inner_join( imdb_movies, tmdb2, by = "simpleTitleMovie")
...
movieTitle <- movies_int$simpleTitleMovie[i]
bookTitle <- movies_int$simpleTitleBook[i] 
...
write_csv(book_movie, "./data/CSV/book_movie.csv")
